...
class AuthorServiceTest {
    ...
    public void 작가정보수정() {
        ...
        MockMultipartFile thumb = null;
        try {
            thumb = new MockMultipartFile("content", "sample_images_02.png", "multipart/mixed", new FileInputStream("/Users/taeku/Desktop/샘플이미지_12가지_모음/sample_images_01.png"));

            AuthorModifyDTO authorModifyDTO = new AuthorModifyDTO(8L, "sexual1102", "Hi, I'm catching error", thumb);
