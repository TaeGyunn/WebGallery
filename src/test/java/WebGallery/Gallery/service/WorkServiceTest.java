...
//
//        try {
//            MockMultipartFile thumb = new MockMultipartFile("content","sample_images_02.png","multipart/mixed", new FileInputStream("/Users/taeku/Desktop/샘플이미지_12가지_모음/sample_images_01.png"));
//            List<String> tags = new ArrayList<>();
//            tags.add("노답");
//            tags.add("카페");
//            tags.add("아메리카노");
//            InsertWorkDTO insertWorkDTO = new InsertWorkDTO(8L, "HOLLYS COFFEE_1102", "cafe", "Coffee_1102", thumb, tags);
//
